      ...
      <div class="row"> 
        <div class="col-md-12">
          ...
          <div class="box box-black"> 
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{ url('/employee/create') }}" style="margin-bottom: 40px;">
              {{ csrf_field() }}
              ...
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" id="datepicker5" name="date_of_birth">
                  </div> 
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="next_of_kin" name="next_of_kin" placeholder="Enter Next of Kin" required>
                </div>

                <div class="form-group col-md-6">
                  <label for="next_of_kin_id_no">Next of Kin ID Number</label>
                  <input type="text" class="form-control" id="next_of_kin_id_no" name="next_of_kin_id_no" placeholder="Enter Next of Kin ID Number" required>
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="url" class="form-control" id="linkedin_url" name="linkedin_url" placeholder="LinkedIn Profile Url" required>
                </div>
              </div>
              <!-- /.box-body -->
